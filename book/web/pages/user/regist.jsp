...
<%--									<%=request.getAttribute("msg")==null?"":request.getAttribute("msg")%>--%>
							...
							<div class="form">
								<form action="UserServlet" method="post">
									...
									<br />
									<label>验证码：</label>
									<input class="itxt" type="text" name="code" style="width: 150px;" id="code" value="arcade"/>
									<img alt="" id="id"  src="http://localhost:8080/book/kaptcha.jpg" style="float: right; margin-right: 40px; height: 40px; width: 90px"/>
									<br />
									<br />
